  ...
  const groups=[
...

    {
      ...
      items:[
        ...
        ["Motor Carrier MC Reinstatement","Restore eligible motor carrier operating authority after revocation.","motor-carrier-mc-number-reinstatement.html","MR"],
        ["Broker MC Reinstatement","Restore eligible broker operating authority after revocation.","broker-mc-number-reinstatement.html","BR"],
        ...
        ["FMCSA Name Change","Update the legal or trade name tied to FMCSA operating authority records.","name-change.html","NC"],
